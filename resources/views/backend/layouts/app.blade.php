...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/images/wikrama/favicon-96x96.png') }}" sizes="96x96">
    <link rel="icon" type="image/svg+xml" href="{{ asset('assets/images/wikrama/favicon.svg') }}">
        ...
        <div class="main-panel">
            <div class="main-header">
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="dark">
                        <a href="{{ route('dashboard.admin') }}" class="logo">
                            <img src="assets/images/wikrama.png" alt="navbar brand" class="navbar-brand" height="20"
                                / data-logo-light="{{ asset('assets/images/wikrama.png') }}"
                                src="{{ asset('assets/images/wikrama.png') }}">
                        </a>
                        <div class="nav-toggle">
                            <button class="btn btn-toggle toggle-sidebar">
                                <i class="gg-menu-right"></i>
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown"
                                    ...
                                    <span class="ms-2 profile-username">
                                        <span class="op-7 dynamic-text">Hi,</span>
                                        <span class="fw-bold dynamic-text">ADMIN</span>
                                    </span>
                                </a>
            ...
            <footer class="footer">
                <div class="container-fluid text-center justify-content-center align-items-center">
                    <div class="copyright">
                        2025, By Kelompok KPU <i class="fa fa-heart heart text-danger"></i>
                    </div>
                </div>
            </footer>
        </div>
